    ...
    useEffect(() => {
        (async () => {
            ...
            try {
                ...
                const response = await productApi.getProductsByCategory(data, "643cd88879b4192efedda4e6");
                console.log(response);
                ...
                const response3 = await productApi.getProductsByCategory(data, "643d030051fc7a906603da39");
                    ...
                    <Row justify="center" align="top" key="1" >
                        ...
                        <Col span={15}>
                            <Carousel autoplay className="carousel-image">
                                <div className="img">
                                    <img style={{ width: '100%', height: 250 }} src="http://grasso.com.vn//source/files/Banner%20t7.png" alt="" />

                                </div>
                                <div className="img">
                                    <img style={{ width: '100%', height: 250 }} src="http://grasso.com.vn//source/files/B%C3%ACa%20WEB(1).png" alt="" />
                            ...
                            <div className="product-promotion">
                                ...
                                <div class="product-card">
                                    <div class="product-image">
                                        <img src="http://grasso.com.vn//source/files/39IT(2).png" alt="Sản phẩm 2" />
                                    </div>
                                    <div class="product-name">Bếp từ chỉ có giá từ 3.960.000</div>
                                </div>
                                <div class="product-card">
                                    <div class="product-image">
                                        <img src="https://cdn.tgdd.vn//content/icon-TGDD-OF-100x100-1.gif" alt="Sản phẩm 3" />
                                    </div>
                                    <div class="product-name">Gia dụng giảm đến 50%+</div>
                                </div>
                            </div>
                        </Col>
                        <Col span={5} >
